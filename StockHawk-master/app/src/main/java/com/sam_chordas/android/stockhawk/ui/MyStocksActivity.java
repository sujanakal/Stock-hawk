...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>,CustomResultReceiver.Receiver{
  ...
  final String BID_PRICE = "Bid_price";
  final String RESULT_STATUS = "resultStatus";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    customResultReceiver = new CustomResultReceiver(new Handler());
    ...
    if (savedInstanceState == null) {
      ...
      mServiceIntent.putExtra(RESULT_RECEIVER, customResultReceiver);
      if (isConnected) {
  ...
  public void onReceiveResult(int resultCode, Bundle resultData) {
    if (resultData.getInt(RESULT_STATUS) == GcmNetworkManager.RESULT_FAILURE) {
      /*Toast toast =
              Toast.makeText(mContext, "Stock symbol not found!",
                      Toast.LENGTH_LONG);
      toast.setGravity(Gravity.CENTER, Gravity.CENTER, 0);
      toast.show();*/
